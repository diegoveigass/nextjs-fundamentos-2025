  ...
  return (
    <form className="relative group" onSubmit={handleSearch}>
      ...
      <input
        ...
        className="placeholder:text-gray-300 placeholder:text-body-sm h-10 w-72 bg-transparent border border-gray-400 pl-9 text-gray-100 rounded-md text-body-sm outline-none transition-all duration-200 focus-within:border-blue-300 focus-within:ring-1 focus-within:ring-blue-300"
      />
    </form>
  );
}
